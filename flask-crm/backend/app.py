...
def model():
    if request.method == "GET":
        ...
        print("\n\nOverall:", actual_rating, average_user_rating, average_product_rating)
        ...
        print("\n\nOverall after imputing:", actual_rating, average_user_rating, average_product_rating)
        ...
        return { "pred": final_predicted_rating , "actual": actual_rating }